...
//	struct AAAA
//	{
//		[SerializeField]TTiming timing;
//		[SerializeField]List<CAffect> Affects;
//	}

//	// 変数宣言
//	//[SerializeField, Tooltip("効果")] private Dictionary<TTiming, List<CAffect>> m_AffectEvents;  // 疑似イベントに紐づけた効果インスタンスリスト
//	[SerializeField, Tooltip("効果")] private struct<AAAA> m_AffectEvents;  // 疑似イベントに紐づけた効果インスタンスリスト
//	[SerializeField]float fff;
